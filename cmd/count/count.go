...
func runCount(params *Params) error {
...
func countReader(reader io.Reader, filename string, params *Params) (CountResult, error) {
...
func printResult(result CountResult, params *Params, showFilename bool) {
	var parts []string
