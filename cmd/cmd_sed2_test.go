...
func TestProcessSed2Reader_LiteralReplace(t *testing.T) {
	input := "Hello World\nWorld of Go\nGoodbye"
	params := &Sed2Params{
		From:       "World",
		To:         "Universe",
		SearchType: SedPatternTypeLiteral,
		Global:     false,
	}
	...
	err = processSed2Reader(strings.NewReader(input), &output, pattern, params)
	if err != nil {
		t.Fatalf("processSed2Reader failed: %v", err)
	}
...
func TestProcessSed2Reader_LiteralReplaceGlobal(t *testing.T) {
...
func TestProcessSed2Reader_RegexReplace(t *testing.T) {
	input := "test123\ntest456\nother"
	params := &Sed2Params{
		From:       `test\d+`,
		To:         "NUM",
		SearchType: SedPatternTypeRegex,
		Global:     false,
	}
...
func TestProcessSed2Reader_RegexCaptureGroups(t *testing.T) {
	input := "John Doe\nJane Smith"
	params := &Sed2Params{
		From:       `(\w+) (\w+)`,
		To:         "$2, $1",
...
func TestProcessSed2Reader_IgnoreCase(t *testing.T) {
	input := "Hello WORLD\nworld hello"
	params := &Sed2Params{
		From:       "world",
		To:         "UNIVERSE",
...
func TestProcessSed2Reader_NoMatch(t *testing.T) {
	input := "Hello World\nGoodbye"
	params := &Sed2Params{
		From:       "test",
		To:         "TEST",
...
func TestProcessSed2File_ReadOnly(t *testing.T) {
	tmpDir := t.TempDir()
	...
	if err != nil {
		t.Fatalf("processSed2File failed: %v", err)
	}
...
func TestProcessSed2File_InPlace(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestProcessSed2File_FileNotFound(t *testing.T) {
	params := &Sed2Params{
		From:       "test",
		To:         "TEST",
		SearchType: SedPatternTypeLiteral,
	...
	err = processSed2File("/nonexistent/file.txt", pattern, params)
	if err == nil {
		t.Errorf("Expected error for non-existent file")
	}
}

func TestRunSed2_InvalidPattern(t *testing.T) {
	params := &Sed2Params{
		From:       "[invalid",
		To:         "test",
		SearchType: SedPatternTypeRegex,
...
func TestProcessSed2Reader_EmptyLine(t *testing.T) {
	input := "line1\n\nline3"
	params := &Sed2Params{
		From:       "line",
		To:         "LINE",
...
func TestProcessSed2Reader_SpecialCharacters(t *testing.T) {
	input := "test.txt\ntest*txt"
	params := &Sed2Params{
		From:       "test.txt",
		To:         "result",
...
func TestProcessSed2Reader_MultipleGlobalReplacements(t *testing.T) {
	input := "a a a a a"
	params := &Sed2Params{
		From:       "a",
		To:         "b",
...
func TestProcessSed2File_InPlace_MultipleLines(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestProcessSed2Reader_RegexIgnoreCase(t *testing.T) {
	input := "Hello WORLD\nworld hello"
	params := &Sed2Params{
		From:       "w[oO]rld",
		To:         "UNIVERSE",
