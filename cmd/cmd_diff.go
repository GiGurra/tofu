...
func DiffCmd() *cobra.Command {
	return boa.CmdT[DiffParams]{
		...
		RunFunc: func(params *DiffParams, cmd *cobra.Command, args []string) {
...
func runDiff(params *DiffParams) error {
	// Read both files
...
func shouldUseColor(params *DiffParams) bool {
	if params.NoColor {
		return false
	}
	switch params.Color {
...
func printSideBySide(lines1, lines2 []string, diff []DiffLine, params *DiffParams, useColor bool) {
